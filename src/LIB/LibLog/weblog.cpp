...
void Logger::GenerateLogName()
{
	...
	sprintf(temp, "%04d-%02d-%02d%02d%02d%02d.log", pTimeInfo->tm_year+1900, pTimeInfo->tm_mon + 1, pTimeInfo->tm_mday,pTimeInfo->tm_hour,pTimeInfo->tm_min,pTimeInfo->tm_sec);
